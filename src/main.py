...
while True:
    ...
    if snake.left < 0 or snake.right > WINDOW or snake.top < 0 or snake.bottom > WINDOW or self_eating:
        snake.center, food1Rect.center, food2Rect.center, food3Rect.center, food4Rect.center, food5Rect.center = get_random_position(
        ), get_random_position(existing_rects), get_random_position(existing_rects), get_random_position(existing_rects), get_random_position(existing_rects), get_random_position(existing_rects)
        length, snake_dir = 1, (0, 0)
        segments = [snake.copy()]
